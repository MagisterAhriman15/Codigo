...
def lanzar_pool_dados(cantidad_dados):
    ...
    for _ in range(cantidad_dados):
        # Simulamos un dado de 6 caras (D6)
...
"""
# Lógica de juego: Contar cuántos dados superan una dificultad (ej. 4+)
exitos = 0
unos_criticos = 0
...
print(f"Total de éxitos (4+): {exitos}")
print(f"Cuidado, sacaste {unos_criticos} resultados de 1.")
"""